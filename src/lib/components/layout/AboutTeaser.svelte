...
<script lang="ts">
  ...
  name: "Jordan Lee",
  role: "Founder & CEO",
  image: "/generated/image-a-confident-entrepreneur-in-business-cas.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
      ...
      text={`"The first time I watched a great team quietly grind to a halt over small miscommunications, I realized nobody was really noticing the early signals. Sentra exists so leaders can spot misalignment before it chips away at culture, productivity, or trust."`}
    />
